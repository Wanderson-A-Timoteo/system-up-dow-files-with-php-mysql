...
<head>
	...
	<title>Script PHP para upload de arquivo - Pure Coding</title>
</head>
<body>
	<div class="file__upload">
		...
		<form action="" method="POST" enctype="multipart/form-data" class="body">
			...
			<label for="link_checkbox" style="<?php echo $link_status; ?>">
Obter link compartilhável</label>

			<input type="file" name="file" id="upload" required>
			<label for="upload">
				<i class="fa fa-file-text-o fa-3x"></i>
				<p>
					<strong>Arrastar e soltar</strong> arquivos aqui<br>
					ou <span>navegue</span> para começar o upload
				</p>
			</label>
